 ...
 implements corbaInterface.ServiceServeurOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getRoomList", new java.lang.Integer (2));
    _methods.put ("createRoom", new java.lang.Integer (3));
    _methods.put ("joinRoom", new java.lang.Integer (4));
    _methods.put ("sendMessage", new java.lang.Integer (5));
    _methods.put ("getHistory", new java.lang.Integer (6));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 2:  // corbaInterface/ServiceServeur/getRoomList
       {
         corbaInterface.Utilisateur utilisateur = corbaInterface.UtilisateurHelper.read (in);
         String $result = null;
         $result = this.getRoomList (utilisateur);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 3:  // corbaInterface/ServiceServeur/createRoom
       {
       ...
       case 4:  // corbaInterface/ServiceServeur/joinRoom
       {
         String roomName = in.read_string ();
         corbaInterface.Utilisateur utilisateur = corbaInterface.UtilisateurHelper.read (in);
         boolean $result = false;
       ...
       case 5:  // corbaInterface/ServiceServeur/sendMessage
       {
       ...
       case 6:  // corbaInterface/ServiceServeur/getHistory
       {
         corbaInterface.Utilisateur utilisateur = corbaInterface.UtilisateurHelper.read (in);
         String $result = null;
       ...
       case 7:  // corbaInterface/ServiceServeur/quit
       {
         corbaInterface.Utilisateur utilisateur = corbaInterface.UtilisateurHelper.read (in);
